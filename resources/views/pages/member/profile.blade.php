...
<x-layout.dashboard title="ملفي الشخصي">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">{{ __('member.profile.subtitle') }}</p>
        </div>
            ...
            <div class="md:col-span-2">
                <x-ui.card class="mb-6">
                    ...
                    <div class="pt-6">
                        <a href="{{ route('profile.edit') }}"
                            class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-4 py-2 rounded-lg transition">
                ...
                <x-ui.card>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">{{ __('member.profile.country') }}
                            </p>
                ...
                <x-ui.card class="sticky top-8">
                    ...
                    <div class="space-y-4">
                        @if ($cardStatus['has_card'])
                            <div
                                class="bg-gradient-to-br from-blue-500 to-purple-600 dark:from-blue-700 dark:to-purple-800 text-white rounded-lg p-6 min-h-48 flex flex-col justify-between">
                                <div>
                            ...
                            <a href="{{ route('member-card.show', $membership->id) }}"
                                class="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded-lg transition text-center">
                                {{ __('member.card.view_button') }}
                            </a>

                            <a href="{{ route('member-card.download', $membership->id) }}"
                                class="w-full bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white font-semibold py-2 px-4 rounded-lg transition text-center flex items-center justify-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button onclick="confirmReissue({{ $membership->id }})"
                                class="w-full bg-yellow-600 hover:bg-yellow-700 dark:bg-yellow-700 dark:hover:bg-yellow-800 text-white font-semibold py-2 px-4 rounded-lg transition">
                                {{ __('member.card.reissue_button') }}
                            </button>

                            @if ($cardStatus['verified'])
                                <div
                                    class="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded-lg p-3 text-sm">
                        ...
                        @else
                            <div
                                class="bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-300 dark:border-yellow-700 rounded-lg p-4 mb-4">
                                <p class="text-yellow-800 dark:text-yellow-400">{{ __('member.card.no_card_created') }}
                                </p>
                            </div>
                        @endif
                    </div>
