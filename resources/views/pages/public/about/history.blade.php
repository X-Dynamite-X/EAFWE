<x-layout.app :title="__('website.history.title')">
    ...
    <div class="max-w-7xl mx-auto px-6 py-24">
        ...
        <div class="relative">
            ...
            <div
                class="absolute right-0 lg:right-1/2 top-0 bottom-0 w-1 bg-gold-100 transform translate-x-1/2">
            </div>
                        ...
                        <div class="w-full lg:w-1/2 p-8 lg:p-12">
                            <div
                                ...
                                <h3 class="text-2xl font-black text-charcoal-900  mb-4">
                                    {{ $item['title'] }}</h3>
                                <p class="text-charcoal-700 leading-relaxed text-lg">
                                    {{ $item['desc'] }}</p>
                            </div>
                        </div>
        ...
        <div
            class="mt-24 p-12 bg-gold-50 rounded-[3rem] border border-gold-200">
