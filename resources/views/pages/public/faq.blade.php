<x-layout.app title="الأسئلة الشائعة">
    ...
    <div class="max-w-7xl mx-auto px-6 py-24">
        <x-ui.section-header title="إجابات لأسئلتك"
            description="نحن هنا لمساعدتك. إليك مجموعة {{ __('common.time.from') }} الأسئلة الأكثر شيوعاً التي قد تدور في ذهنك." />
            ...
            @php
                $faqs = [
                    [
                        ...
                        'a' =>
                            'يمكنك الانضمام {{ __('common.time.from') }} خلال الضغط على زر "انضمي إلينا" في القائمة العلوية وتعبئة استمارة التسجيل الإلكترونية مع إرفاق الوثائق ال{{ __('common.form.required') }}ة.',
                    ],
                    [
                        'q' => 'ما هي أنواع العضويات المتاحة؟',
                        'a' =>
                            'توجد عدة أنواع للعضويات تشمل: العضوية العاملة، العضوية ال{{ __('common.time.from') }}تسبة، وعضوية طالبات الجامعات والمدارس. كل نوع له شروطه ومميزاته الخاصة.',
                    ],
                    [
                    ...
                    [
                        ...
                        'a' =>
                            'نقدم حزمة متكاملة {{ __('common.time.from') }} الخدمات تشمل ال{{ __('modules.training.categories.training') }}، الإرشاد المهني، فرص التشبيك، الدفاع عن مصالح رائدات الأعمال، وتسهيل الوصول لل{{ __('modules.portal.opportunity_types.funding') }} والأسواق.',
                    ],
                    [
                        'q' => 'كيف يمكنني التواصل مع إدارة الجمعية؟',
                        'a' =>
                            'يمكنك التواصل معنا عبر صفحة "اتصل بنا"، أو {{ __('common.time.from') }} خلال {{ __('common.general.email') }} الرسمي، أو زيارة مقرنا في المواعيد الرسمية.',
                    ],
                ];
            @endphp
