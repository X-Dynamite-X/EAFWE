<x-layout.dashboard :title="__('modules.training.create')">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">{{ __('modules.training.fill_form') }}</p>
        </div>
            ...
            <form action="{{ route('dashboard.training.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div x-show="lang === 'ar'" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2">
                                ...
                                (ب{{ __('common.tabs.arabic') }}) <span class="text-red-600">*</span>
                            </label>
                            <input type="text"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2">
                                <i class="fas fa-align-left"></i> {{ __('common.general.description') }}
                                (ب{{ __('common.tabs.arabic') }}) <span class="text-red-600">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2">
                                <i class="fas fa-file-alt"></i> {{ __('modules.training.fields.content') }}
                                (ب{{ __('common.tabs.arabic') }}) <span class="text-red-600">*</span>
                            </label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="category" class="block text-sm font-medium text-gray-900 mb-2">
                            <i class="fas fa-tags"></i> {{ __('common.general.type') }} <span
                                class="text-red-600">*</span>
                        </label>
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            ...
                            <option value="workshop" {{ old('category') == 'workshop' ? 'selected' : '' }}>
                                {{ __('modules.training.categories.workshop') }}
                            </option>
                            <option value="seminar" {{ old('category') == 'seminar' ? 'selected' : '' }}>
                ...
                <div class="flex items-center">
                    ...
                    <label class="mr-2 text-sm text-gray-900"
                        for="is_active">{{ __('modules.training.publish_program') }}</label>
                </div>
