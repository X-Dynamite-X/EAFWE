<x-layout.dashboard title="{{ __('common.actions.edit') }} برنامج ال{{ __('modules.training.categories.training') }}">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('common.actions.edit') }} برنامج ال{{ __('modules.training.categories.training') }}</h1>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="training"
                                {{ old('category', $program->category) == 'training' ? 'selected' : '' }}>{{ __('modules.training.categories.training') }}
                            </option>
                            <option value="workshop"
                                {{ old('category', $program->category) == 'workshop' ? 'selected' : '' }}>{{ __('modules.training.categories.workshop') }}
                            </option>
                            <option value="seminar"
                                {{ old('category', $program->category) == 'seminar' ? 'selected' : '' }}>{{ __('modules.training.categories.seminar') }}</option>
                        </select>
                    </div>
                    <div>
