<x-layout.dashboard title="{{ __('modules.entrepreneurship.title') }}">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">{{ __('modules.entrepreneurship.subtitle') }}</p>
        </div>
        @can('manage entrepreneurship programs')
            <x-ui.button href="{{ route('dashboard.entrepreneurship.manage') }}" color="primary">
                <i class="fas fa-cog"></i> {{ __('modules.entrepreneurship.manage_button') }}
            </x-ui.button>
        @endcan
    </div>
                    ...
                    <div class="flex-1 flex flex-col">
                        ...
                        <div class="mt-auto pt-4 border-t border-gray-200">
                            <a href="{{ route('dashboard.entrepreneurship.show', $program) }}"
                                ...
                                {{ __('modules.entrepreneurship.program_details') }}
    ...
    @else
        <x-ui.alert type="info" class="text-center">
            ...
            <p class="text-gray-700 font-medium">{{ __('modules.entrepreneurship.no_programs_available') }}</p>
        </x-ui.alert>
    @endif
</x-layout.dashboard>
