<x-layout.dashboard title="إدارة برامج الريادة">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">أضف وعدل وحذف برامج الريادة والعمل الحر</p>
        </div>
                ...
                <div class="flex flex-wrap gap-2 mb-3">
                    <x-ui.badge color="yellow" size="sm">
                        @switch($program->type)
                            ...
                            @break
                            @case('startup')
                                <i class="fas fa-lightbulb"></i> شركة ناشئة
                            @break
                            @case('mentorship')
    ...
    <x-ui.card>
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 text-sm mt-2 mb-6">ابدأ بإنشاء برنامج ريادة جديد الآن</p>
            <x-ui.button href="{{ route('dashboard.entrepreneurship.create') }}" color="primary">
