<x-layout.dashboard title="الاتصالات والإعلانات">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">الاتصالات والإعلانات</h1>
    ...
    <div class="space-y-4">
        ...
        <x-ui.card>
            ...
            <div class="mt-4">
                <x-ui.button href="{{ route('dashboard.communication.show', $communication) }}" color="primary" size="sm">
                    اقرأ المزيد <i class="fas fa-arrow-left text-xs"></i>
                </x-ui.button>
            </div>
        </x-ui.card>
        @endforeach
    ...
    <x-ui.card>
        <div class="text-center py-8">
            ...
            <p class="text-gray-600">لا توجد اتصالات متاحة حالياً</p>
        </div>
    </x-ui.card>
    @endif
</x-layout.dashboard>
