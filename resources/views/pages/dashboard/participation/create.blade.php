<x-layout.dashboard title="{{ __('common.actions.add') }} فرصة مشاركة جديدة">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('common.actions.add') }} فرصة مشاركة جديدة</h1>
            <p class="text-gray-600 mt-1">ملأ ال{{ __('modules.marketing.resource_types.template') }} أدناه ل{{ __('common.actions.create') }} فرصة مشاركة جديدة</p>
        </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="volunteer" {{ old('type') == 'volunteer' ? 'selected' : '' }}>{{ __('modules.participation.types.volunteer') }}</option>
                            <option value="partner" {{ old('type') == 'partner' ? 'selected' : '' }}>{{ __('modules.participation.types.partner') }}</option>
                            <option value="sponsor" {{ old('type') == 'sponsor' ? 'selected' : '' }}>{{ __('modules.participation.types.sponsor') }}</option>
                        </select>
                        @error('type')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
