<x-layout.dashboard title="{{ __('modules.participation.create') }}">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('modules.participation.create') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('modules.participation.fill_form') }}</p>
        </div>
        ...
        <x-ui.card>
            <form action="{{ route('dashboard.participation.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="partner" {{ old('type') == 'partner' ? 'selected' : '' }}>
