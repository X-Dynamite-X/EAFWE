<x-layout.dashboard title="{{ __('modules.participation.edit') }}">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('modules.participation.edit') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('modules.participation.update_data') }}</p>
        </div>
            ...
            <form action="{{ route('dashboard.participation.update', $opportunity) }}" method="POST"
                ...
                <div x-data="{ lang: 'ar' }">
                    ...
                    <div x-show="lang === 'ar'" class="space-y-4">
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-900 mb-2">{{ __('modules.participation.fields.content') }}
                                {{ __('common.general.in_arabic') }} <span class="text-red-600">*</span></label>
                    ...
                    <div x-show="lang === 'en'" class="space-y-4" style="display: none;">
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2 text-left"
                                dir="ltr">{{ __('modules.participation.fields.title_en') }} <span
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2 text-left"
                                dir="ltr">{{ __('modules.participation.fields.description_en') }} <span
                                    class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-2 text-left"
                                dir="ltr">{{ __('modules.participation.fields.content_en') }} <span
                                    class="text-red-600">*</span></label>
                            <textarea dir="ltr" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    <label
                        class="block text-sm font-medium text-gray-900 mb-2">{{ __('modules.participation.fields.slug') }}
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-900 mb-2">{{ __('modules.participation.fields.start_date') }}
                            <span class="text-red-600">*</span></label>
                        <input type="date"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            name="start_date"
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-900 mb-2">{{ __('modules.participation.fields.end_date') }}
                            <span class="text-red-600">*</span></label>
                        <input type="date"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        @if ($opportunity->image_url)
                            <div class="mb-3 p-3 bg-blue-50 rounded-lg">
                                <p class="text-sm text-blue-900">{{ __('common.general.current_image') }}: <img
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="volunteer"
                                {{ old('type', $opportunity->type) == 'volunteer' ? 'selected' : '' }}>
                                {{ __('modules.participation.types.volunteer') }}</option>
                            <option value="partner"
                                {{ old('type', $opportunity->type) == 'partner' ? 'selected' : '' }}>
                                {{ __('modules.participation.types.partner') }}</option>
                            <option value="sponsor"
                                {{ old('type', $opportunity->type) == 'sponsor' ? 'selected' : '' }}>
                                {{ __('modules.participation.types.sponsor') }}</option>
                        </select>
                        @error('type')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="flex items-center">
                    ...
                    <label
                        class="mr-2 text-sm text-gray-900">{{ __('modules.participation.publish_opportunity') }}</label>
                </div>
