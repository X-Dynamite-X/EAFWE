<x-layout.dashboard title="إدارة موارد التسويق">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">أضف وعدل و{{ __('common.actions.delete') }} موارد التسويق والإعلام</p>
        </div>
                ...
                <div class="flex flex-wrap gap-2 mb-3">
                    <x-ui.badge color="green" size="sm">
                        @switch($resource->resource_type)
                            ...
                            @break
                            @case('case_study')
                                <i class="fas fa-graduation-cap"></i> {{ __('modules.marketing.resource_types.case-study') }}
                            @break
                        @endswitch
                    </x-ui.badge>
    ...
    <x-ui.card>
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 text-sm mt-2 mb-6">ابدأ ب{{ __('common.actions.create') }} مورد تسويقي جديد الآن</p>
            <x-ui.button href="{{ route('dashboard.marketing.create') }}" color="primary">
                <i class="fas fa-plus"></i> {{ __('common.actions.add') }} مورد جديد
            </x-ui.button>
        </div>
    </x-ui.card>
    @endif
