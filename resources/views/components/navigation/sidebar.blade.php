    ...
    <div class="p-8 h-full flex flex-col overflow-y-auto">
        ...
        <nav class="space-y-2">
            @php
                $menuItems = [
                    ...
                    [
                        'label' => __('dashboard.sidebar.roles'),
                        'route' => 'roles.index',
                        'icon' =>
                    ...
                    [
                        'label' => __('dashboard.sidebar.memberships'),
                    ...
                    // Member Services
                    [
                        'label' => __('dashboard.sidebar.services'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.entrepreneurship'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.participation'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.files'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.marketing'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.communication'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.portal_opportunities'),
                    ...
                    [
                        'label' => __('dashboard.sidebar.member_card'),
                        'route' => 'member.profile',
                        'icon' =>
                            '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m-4 4v2m4 4v2M9 5h.01M5 9h.01M9 15h.01M5 5a4 4 0 110 8 4 4 0 010-8zm6 10a4 4 0 110 8 4 4 0 010-8z"></path></svg>',
        ...
        <nav class="space-y-2">
            <a href="{{ route('profile.edit') }}"
                class="flex items-center gap-4 px-4 py-3 rounded-xl text-gold-100/70
          ...
          transition duration-300 group">
                 ...
                 transition-all duration-300">
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                            d="M15 19a4 4 0 00-8 0m8 0H7m8 0a4 4 0 00-8 0m8-10a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                </span>
            ...
            <form action="{{ route('logout') }}" method="POST" class="block">
                ...
                <button type="submit"
                    ...
                    <span class="text-sm">{{ __('dashboard.sidebar.logout') }}</span>
                </button>
            </form>
        </nav>
        {{-- </div> --}}
